...
set_target_properties(Calamares::calamares PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libcalamares.so.3.2.50"
  IMPORTED_SONAME_DEBUG "libcalamares.so.3.2.50"
  )

list(APPEND _IMPORT_CHECK_TARGETS Calamares::calamares )
list(APPEND _IMPORT_CHECK_FILES_FOR_Calamares::calamares "${_IMPORT_PREFIX}/lib/libcalamares.so.3.2.50" )
...
set_target_properties(Calamares::calamaresui PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libcalamaresui.so.3.2.50"
  IMPORTED_SONAME_DEBUG "libcalamaresui.so.3.2.50"
  )

list(APPEND _IMPORT_CHECK_TARGETS Calamares::calamaresui )
list(APPEND _IMPORT_CHECK_FILES_FOR_Calamares::calamaresui "${_IMPORT_PREFIX}/lib/libcalamaresui.so.3.2.50" )

...
Column {
    ...
    property var tzCode: (geoipCode != "") ? geoipCode : configCode
    ...
    Rectangle {
        ...
        Item {
            ...
            Rectangle {
                ...
                Text {
                    text: qsTr("Timezone: %1").arg(tzCode)
